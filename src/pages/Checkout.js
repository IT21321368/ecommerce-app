        ...
        <div className='row'>
          <div className='col-7'>
            <div className='checkout-left-data'>
                ...
                <p className='user-details total'>Dev Corner (devcorner@example.com)</p>
                ...
                <form action="" className='d-flex flex-wrap gap-15 justify-content-between'>
                  ...
                  <div className='w-100'>
                    <input type="text" className='form-control' id="name" placeholder='Apartment, suite, etc.' />
                  </div>
                  <div className='flex-grow-1'>
                    <input type="text" className='form-control' id="name" placeholder='City' />
                  </div>
                  <div className='flex-grow-1'>
                    <select name="" className='form-control form-select' id=''>
                  ...
                  <div className='flex-grow-1'>
                    <input type="text" className='form-control' id="name" placeholder='Zip / Postal Code' />
                  </div>
                  <div className='w-100'>
                ...
                <div className='d-flex gap-10 mb-2 align-items-center'>
                    <div className='w-75 d-flex gap-10'>
                        ...
                        <div>
                            ...
                            <p className='total-price'>Size: M</p>
                        </div>
                    </div>
                    <div className='flex-grow-1'>
