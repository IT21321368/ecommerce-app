          ...
          <div className='row'>
            <div className='col-6'>
              ...
              <div className='other-product-images d-flex flex-wrap gap-15'>
                <div>
                  <img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-ferarcosn-190819.jpg&fm=jpg" alt="Product" className='img-fluid' />
                </div>
                <div>
                  <img src="https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-ferarcosn-190819.jpg&fm=jpg" alt="Product" className='img-fluid' />
                </div>
              ...
              <div className='main-product-details'>
                ...
                <div className='py-3'>
                  ...
                  <div className='d-flex align-items-center gap-15'>
                    <div>
                      <a href="#" >
                        <TbGitCompare className='me-2 fs-5'/> Add to Compare</a>
                    </div>
                    <div>
                      <a href="#" ><AiOutlineHeart className='me-2 fs-5'/> Add to Wishlist</a>
                    </div>
                    </div>
                  <div className='d-flex flex-column gap-10 my-3'>
                    ...
                    <b>2-3 business days.</b></p>
                  </div>
                  <div className='d-flex align-items-center gap-10 my-3'>
                    <h3 className='product-heading'>Product link:</h3>
                    <a href='javascript:void(0);' onClick={() => {copyToClipboard("https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-ferarcosn-190819.jpg&fm=jpg")}}>Copy Product Link</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='col-12'>
              ...
              <div className='review-inner-wrapper'>
                ...
                <div className='review-form py-4'>
                  ...
                  <div>
                    <textarea name='' id='' className='w-100 form-control' cols={3} rows={4} placeholder='Comments'/>
                  </div>
